...
This inventory describes the versioned US research catalog after the Finnleo depth batch. Counts include published records and non-public candidates. Placement counts overlap for products documented for both indoor and outdoor use.

## Current inventory

| Dimension | Segment | Products |
| --- | --- | ---: |
| Product type | Sauna cabin | 151 |
...
| Placement | Indoor | 143 |
| Placement | Outdoor | 141 |
| Placement | Not normalized | 25 |
| Seated capacity | 1 person | 16 |
| Seated capacity | 2 people | 40 |
| Seated capacity | 3–4 people | 83 |
...
- 81 configurations still lack a documented seated capacity.
- 139 configurations still lack complete exterior dimensions.
- 118 configurations still lack model-level materials.
- 197 configurations still lack a documented supply voltage.
- A substantial candidate set remains below the internal completeness threshold and should not be published without model-level review.
