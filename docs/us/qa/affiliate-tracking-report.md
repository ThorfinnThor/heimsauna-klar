...
**Task:** L-13  
**Scope:** indexed US release, 115 catalog records, four Awin program records

## Result

The US release has thirteen manually reviewed affiliate offers. Sweat Kingdom Saunas is approved for publisher `3037577` based on operator confirmation, its program terms and exact product mappings. The remaining three Awin programs remain research candidates. Feed synchronization is disabled.
...
| --- | ---: | --- | --- | --- | --- |
| Sweat Kingdom Saunas | 125462 | Sweat Kingdom | `approved` | `awin1.com`, deeplink | thirteen reviewed offers active |
...
The catalog contains 115 products and 115 exact configurations. Thirteen products have approved commercial mappings to Sweat Kingdom. Ninety-two records remain research candidates and do not receive affiliate output.
...
**L-13: PARTIALLY ACCEPTED.** Sweat Kingdom is active with thirteen exact offers. Peak Saunas, Sunlighten and JNH Lifestyles remain blocked pending account evidence and exact approved targets.
