...
snapshot.purpose = `Public indexed US release with ${offers.offers.length} manually reviewed Sweat Kingdom merchant offers. ${products.products.filter((product) => product.publication_status === "candidate").length} research records stay candidates; feed synchronization and manufacturer image use remain disabled.`;
