...
const records = [
  { id: "finnleo-northstar-indoor-sauna-4-x-4-9-0550", capacity: 2, dimensions: dimensions(48, 48, 80), voltage: 120, power: 2200, connection: "plug-in", dedicated: true, material: "Nordic White Spruce interior and exterior; Clear Abachi or Aspen benches and backrests", url: "https://www.finnleo.com/products/northstar-indoor-sauna-4-x-4-9-0550", form: "Indoor traditional sauna cabin" },
