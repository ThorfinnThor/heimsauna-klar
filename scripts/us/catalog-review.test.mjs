...
test("the current indexed first-wave catalog has a reproducible review report", () => {
  ...
  assert.equal(report.summary.candidatesAwaitingReview, 220);
  ...
  assert(report.blockers.includes("220 candidate or draft products still require their first technical review."));
