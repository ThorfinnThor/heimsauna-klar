...
test("the current protected catalog has a reproducible review report", () => {
  ...
  assert.equal(report.summary.candidatesAwaitingReview, 100);
  ...
  assert(report.blockers.includes("100 candidate or draft products still require their first technical review."));
