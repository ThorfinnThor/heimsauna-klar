...
<!-- BEGIN:project-seo-quality-rules -->

# SEO and editorial page quality

- Do not publish collections, comparison pages, or planning guides from one rigid page template with only keywords, titles, or product data exchanged.
- Shared navigation, design primitives, and accessible components are allowed, but every indexable editorial page needs an intentional query-specific module order, narrative angle, evidence base, and genuinely useful decision support.
- Keep editorial content and presentation profiles in versioned JSON so pages remain statically generated and reviewable. Copy must be original, source-based, substantial, people-first, and written for the concrete search intent.
